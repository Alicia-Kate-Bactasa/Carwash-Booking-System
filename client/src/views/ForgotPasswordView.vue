      ...
      <div v-if="step === 3" class="space-y-4 mt-4 pt-4 border-t border-neutral-100">
        <div class="relative w-full">
          ...
          <div class="relative">
            ...
            />
            <button type="button" class="absolute right-4 top-1/2 -translate-y-1/2 text-neutral-400 hover:text-dark focus:outline-none transition-colors p-1" @click="showPassword = !showPassword" aria-label="Toggle Password Visibility">
        ...
        <div class="relative w-full">
          ...
          <div class="relative">
            <input 
              ...
              class="w-full bg-neutral-50 border border-neutral-200 p-3.5 rounded-full text-xs font-semibold focus:outline-none focus:border-dark px-5 pr-12"
            />
            <button type="button" class="absolute right-4 top-1/2 -translate-y-1/2 text-neutral-400 hover:text-dark focus:outline-none transition-colors p-1" @click="showConfirmPassword = !showConfirmPassword" aria-label="Toggle Confirm Password Visibility">
              <svg v-if="!showConfirmPassword" xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                <path stroke-linecap="round" stroke-linejoin="round" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
              </svg>
              <svg v-else xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
