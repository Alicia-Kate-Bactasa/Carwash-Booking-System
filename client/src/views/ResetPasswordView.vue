      ...
      <form @submit.prevent="handleResetPassword" class="space-y-4">
        <div class="relative w-full">
          ...
          <div class="relative">
            ...
            />
            <button type="button" class="absolute right-4 top-1/2 -translate-y-1/2 text-neutral-400 hover:text-dark focus:outline-none transition-colors p-1" @click="showPassword = !showPassword">
        ...
        <div class="relative w-full">
          ...
          <div class="relative">
            <input 
              ...
              class="w-full bg-neutral-50 border border-neutral-200 p-3.5 rounded-full text-xs font-semibold focus:outline-none focus:border-dark px-5 pr-12"
            />
            <button type="button" class="absolute right-4 top-1/2 -translate-y-1/2 text-neutral-400 hover:text-dark focus:outline-none transition-colors p-1" @click="showConfirmPassword = !showConfirmPassword">
